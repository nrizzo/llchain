...
paste -d'$' stats_plant_mum_headers \
	stats_time_plant_mum_chainx     stats_avg_chaining_time_plant_mum_chainx     stats_space_plant_mum_chainx \
	stats_time_plant_mum_chainx-opt stats_avg_chaining_time_plant_mum_chainx-opt stats_space_plant_mum_chainx-opt \
	stats_time_plant_mum_llchain    stats_avg_chaining_time_plant_mum_llchain    stats_space_plant_mum_llchain \
	| cat <(echo -e "\$ChainX*\$\$\$ChainX-opt*\$\$\$llchain") - | column -t -s'$'
...
paste -d'$' stats_hprc_mum_headers \
	stats_time_hprc_mum_chainx     stats_avg_chaining_time_hprc_mum_chainx     stats_space_hprc_mum_chainx \
	stats_time_hprc_mum_chainx-opt stats_avg_chaining_time_hprc_mum_chainx-opt stats_space_hprc_mum_chainx-opt \
	stats_time_hprc_mum_llchain    stats_avg_chaining_time_hprc_mum_llchain    stats_space_hprc_mum_llchain \
	| cat <(echo -e "\$ChainX*\$\$\$ChainX-opt*\$\$\$llchain") - | column -t -s'$'
