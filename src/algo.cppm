 ...
 *     in practice)
 */
//void prune_shadowed_delimiting_lines_naive(case_three_index_naive &I, ai_t sweeping_line_a);
void prune_shadowed_delimiting_lines(case_three_index &I, const ai_t sweeping_line_a);

///*
// * case 1a: overlap in T, bigger diagonal
...
///*
// * case 1b: overlap in T, smaller diagonal
// *   requires a 1-dimensional range minimum query data structure where the
// *   (static) positions are anchor diagonals and the values (dynamic, better
...
//		I.recursive_values[j_diag] = min(I.recursive_values[j_diag], rec_value);
//	} else {
...
//		I.recursive_values[j_d-1] = min(I.recursive_values[j_d-1], rec_value);
//	} else {
