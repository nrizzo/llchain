...
class BmpImage {
 public:
  ...
  // chars between 0 and 256.
  void putpixel(int w, int h, char r, char g, char b);
...
BmpImage::BmpImage(int w, int h): width(w), height(h) {
  clear(Color((char)255,(char)255,(char)255));
}

void BmpImage::putpixel(int x, int y, char r, char g, char b) {
...
////  Purpose:
////
////    grid_to_bmp() creates a Microsoft BMP image from grid data.
////
////  Discussion:
////
